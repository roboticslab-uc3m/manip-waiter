...
/*    trunkITorqueControl->getAxes(&numTrunkJoints);
    ...
    rightLegSolverOptions.fromConfigFile("/usr/local/share/teo-configuration-files/contexts/kinematics/rightLegKinematics.ini");
    ...
    leftLegSolverOptions.fromConfigFile("/usr/local/share/teo-configuration-files/contexts/kinematics/leftLegKinematics.ini");
    ...
    threadImpl.setITorqueControl(rightLegITorqueControl,leftLegITorqueControl); // no se utiliza de momento
